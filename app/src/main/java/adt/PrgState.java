...
public class PrgState{
    ...
    private MyILock < Integer > lockTable;
    ...
    public PrgState(MyIStack < IStmt > stk, MyIDict < String, Value > symtbl, MyIList < Value >
            ot, MyIFileTable < StringValue, BufferedReader > ftb, MyIHeap < Value > heap, IStmt prg, MyILock < Integer > lock){
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = ftb;
    ...
    public MyILock < Integer > getLock() {
